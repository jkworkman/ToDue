...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ToDue *sightingAtIndex = [self.dataController objectInListAtIndex:indexPath.row];
...
- (IBAction)done:(UIStoryboardSegue *)segue
{
    if ([[segue identifier] isEqualToString:@"ReturnInput"]) {
        ...
        AddNewTaskViewController *addController = [segue sourceViewController];
        if (addController.tempTask) {
            [self.dataController addTask:addController.tempTask];
